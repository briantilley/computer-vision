...
public:
	...
	RawFrame(unsigned imageWidth, unsigned imageHeight, unsigned allocationCols, unsigned allocationRows,
...
protected:
	...
	bool residesInGPUmemory; // indicates where data is located
};
